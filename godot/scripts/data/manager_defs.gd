...
const _RAW: Array = [
	...
	["The Mechanic", 2, "Chop shop runs itself.", 8_000.0, "Night Shift", "1.5x Chop Shop + purchase orders after 1st prestige", "Night Shift"],
	...
	["The Accountant", 5, "Makes debts disappear.", 65_000.0, "Fixer", "1.5x Loan Shark + best-buy orders after 1st prestige", "Automation"],
