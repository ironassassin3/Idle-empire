...
def make_goals() -> List[Goal]:
    ...
    return [
        ...
        Goal(
            ...
            desc='Earn $8,000 from your empire (passive + clicks). First Influence.',
            progress=lambda s: (_route_earnings(s), 8_000),
            reward_cash=500, reward_influence=2,
            color=theme.PRESTIGE_LABEL,
        ),
        Goal(
            key='start_cash_25k', label='Getting Noticed ($25K)', phase='early',
            desc='Earn $40,000 from your empire. +1 Influence.',
            progress=lambda s: (_route_earnings(s), 40_000),
            reward_cash=2_000, reward_influence=1,
            color=theme.PRESTIGE_LABEL,
        ),
        Goal(
            key='start_cash_100k', label='Six Figures ($100K)', phase='early',
            desc='Earn $150,000 from your empire. +2 Influence.',
            progress=lambda s: (_route_earnings(s), 150_000),
            reward_cash=8_000, reward_influence=2,
            color=theme.PRESTIGE_LABEL,
        ),
        Goal(
            key='start_cash_250k', label='Connected ($250K)', phase='early',
            desc='Earn $400,000 from your empire. +2 Influence.',
            progress=lambda s: (_route_earnings(s), 400_000),
            reward_cash=20_000, reward_influence=2,
            color=theme.PRESTIGE_LABEL,
        ),
        Goal(
            key='start_cash_500k', label='Respected ($500K)', phase='early',
            desc='Earn $800,000 from your empire. +3 Influence.',
            progress=lambda s: (_route_earnings(s), 800_000),
            reward_cash=40_000, reward_influence=3,
            color=theme.PRESTIGE_LABEL,
        ),
        Goal(
            key='start_cash_1m_inf', label='Made (empire $1M)', phase='early',
            desc='Earn $2,000,000 from your empire. +3 Influence — you are Made.',
            progress=lambda s: (_route_earnings(s), 2_000_000),
